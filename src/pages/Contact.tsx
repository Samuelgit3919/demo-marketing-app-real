        ...
        <section className="px-6 lg:px-10">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <form onSubmit={onSubmit} className="bg-white border border-brand-border rounded-2xl p-8 space-y-4">
              ...
              <button type="submit" className="w-full bg-brand-copper text-white text-sm tracking-[0.2em] uppercase font-medium px-8 py-4 rounded-full hover:bg-brand-copper-dark transition-all duration-300 shadow-lg">
                Send Message
              </button>
            </form>
          </div>
