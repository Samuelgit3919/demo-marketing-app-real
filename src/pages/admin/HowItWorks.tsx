      ...
      <div className="min-h-screen bg-brand-cream py-10 px-4">
        <div className="max-w-4xl mx-auto space-y-8">
          <div>
            ...
            <p className="text-brand-muted">Edit the 5-step transformation timeline shown on the How It Works page.</p>
          </div>

          {loading ? (
            <div className="flex justify-center py-20"><Loader2 className="w-6 h-6 animate-spin text-brand-copper" /></div>
          ) : (
            <SectionCard title="How It Works — Steps" description="The 5-step timeline. (Icons and numbers stay fixed.)" saving={saving} onSave={save}>
